    ...
    <div className="AddingPage">
          ...
          props.type === 0
            ? props.categoryTypes[0].map((item, idx) => {
                if (idx === props.index) {
                  return (
                    <li
                      onClick={props.chooseItem.bind(this, [idx, item.name])}
                      key={idx}
                    >
                      <item.iconName
                        className="rounded-circle chosen"
                        style={{ color: "#fff" }}
                      />
                      <p>{item.name}</p>
                    </li>
                  ...
                  return (
                    ...
                    >
                      <item.iconName
                        className="rounded-circle unchosen"
                        style={{ color: "#888" }}
                      />
                      <p>{item.name}</p>
                    </li>
      ...
      <div className="detail">
        ...
        <div className="outcomeType">
          <span>Type of income and expenditure</span>
          <Select defaultValue="Expenditure" onChange={props.typeChange}>
        ...
        <div className="outcomeDate">
          ...
          <Space direction="vertical" size={12}>
            <DatePicker
              defaultValue={moment(props.getDate_add(), dateFormat)}
              format={dateFormat}
      ...
      <div className="footer-add">
        <button className="finish-btn" onClick={props.confirm}>
          Submit
        </button>
