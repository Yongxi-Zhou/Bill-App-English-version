  ...
  return (
    <Wrapper className="container-statistics">
          ...
          {selectIn_out === 0
            ? billTypes.slice(0, 8).map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <div key={item + "text"} className="text">
                      {item}
                    </div>
                  </div>
                );
            ...
            : billTypes.slice(8).map((item, index) => {
                return (
                  <div
                    key={item + "typeItem"}
                    className={getTypeClass(index + 8)}
                    onClick={() => changeType(index + 8)}
                  >
                    <Icon key={item + "icon"} name={item} />
                    <div key={item + "text"} className="text">
                      {item}
      ...
      <div className="footerBar">
        <div className="ok" onClick={() => updateItem(newItem.id, newItem)}>
          完成
        </div>
        <div className="delete" onClick={() => deleteItem(newItem.id)}>
          删除
        </div>
      </div>
    </Wrapper>
